        ...
        if(!isset($_GET['change_pass'])){
          ...
          if($count_orders>0)
          {
            echo "<div style='padding:10px;'>
                 ...
                 <a style='text-decoration:none; color:black;' href='../index1.php'>Continue Shopping</a>
                  </div>
              ...
              if(!isset($_GET['cat']))
          {
              ...
              while ($row_products=mysqli_fetch_array($run_products))
              {
               ...
               echo "
                ...
                <a href='details.php?pro_id=$pro_id' style='text-decoration:none;color:black;'><div class='card'>
                    <img src='admin_area/product_images/$pro_image' height='220px;'>
                    <div class='card-text'><b>$pro_title</b>
                    
                         <div class='sub-heading1'><b>Rs.$pro_price</b></div>
                    <div>
                   <a href='index1.php?add_cart=$pro_id'><button style=text-align:center;margin-top:5px;'>ADD TO CART</button></a>
                    </div>
