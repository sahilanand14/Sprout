                ...
                $pro_image1=$row_products['product_img1'];
                 $pro_image2=$row_products['product_img2'];
                  $pro_image3=$row_products['product_img3'];
                   $original_price=$pro_price+1000;
		$discount=floor((($original_price-$pro_price)/$original_price)*100);
                   
               echo "


                  <div id='details_main_container' style='padding-left: 168px;float:left;'>
                   <div style='float:left;'>
                   <div id='leftNav' style='float: left'>

                      <img class='left_nav_images' src='admin_area/product_images/$pro_image1' height='80px;' onclick=\"showImage('$pro_image1');\">
                      
                      <img class='left_nav_images' src='admin_area/product_images/$pro_image2' height='80px;' onclick=\"showImage('$pro_image2');\" >
                       
                       <img class='left_nav_images' src='admin_area/product_images/$pro_image3' height='80px;' onclick=\"showImage('$pro_image3');\" >
                        
      
      
   </div>
   <div id='rightDisplay' style='float: left;
    margin-left:10px;'>
      <img id='currentImg'  src='admin_area/product_images/$pro_image1' height='580px;' />
   </div>
   </div>
 <div style='float: left;
width: 500px;
padding-left: 87px;'>
                  <div style='margin-top:-21px;border-bottom:1px solid #c0c1c7;'><h1 style='margin-bottom:0px;' class='sub-heading'>$pro_title</h1><span style='font-size:16px;color:grey;line-height:9px;'><strike>Rs.$original_price</strike></span>
                  <h1 style='color:#f16565;' class='sub-heading'>Rs. $pro_price <span style='color: #068406;
    margin-left: 10px;
    border-radius: 10%;
    padding: 0px 4px;
    background: #ffff09;'>$discount%OFF</span></h1>
                  

                  </div>
                 <div style='font-size:15px;border-bottom:1px solid #c0c1c7;'><h1 class='sub-heading'>Product Details</h1><p style='color:#696b79;text-align:justify;'>$pro_desc</p></div>
                 
                 

                 <div class='size_button_container'>
                       <div class='size_button_header'>
                       <h1 class='sub-heading'>Select size</h1>
                             <div class='boxed'>
  ...
  <br><br>
                  ...
                  <a href='index1.php?add_cart=$pro_id' style='text-decoration:none;color:white;'><button style='width:250px;font-size:15px;font-weight:500'  class='add_cart_button button1'>
                ADD TO CART
                 </button>
                 </a>
                 </div>
...
function showImage(imgName) {
   ...
   var thePath = 'admin_area/product_images/';
