	...
	<table width="700" align="center" style="border: 8px groove;margin-top: 40px;">
			...
			<tr>
			 <td align="right"><b>Product Image1</b></td>
				<td><input type="file" name="product_img1" /><br><img src="product_images/<?php echo $p_image1;   ?>" width="80px"  height="80px" /></td>
			</tr>
			<tr>
			<td align="right"><b>Product Image2</b></td>
				<td><input type="file" name="product_img2" /><br><img src="product_images/<?php echo $p_image2;   ?>" width="80px"  height="80px" /></td>
			</tr>
			<tr>
			<td align="right"><b>Product Image3</b></td>
				<td><input type="file" name="product_img3" /><br><img src="product_images/<?php echo $p_image3;   ?>" width="80px"  height="80px" /></td>
			</tr>
			<tr>
			...
			<td align="right"><b>Product Description</b></td>
				<td><textarea type="text" name="product_desc" cols="40" rows="8"><?php echo $p_desc; ?></textarea></td>
			</tr>
			<tr>
			<td align="right"><b>Product Keywords</b></td>
				<td><input type="text" name="product_keywords" value="<?php echo $p_desc; ?>" /></td>
			</tr> 
...
if(isset($_POST['update_product'])&& !empty($_POST['update_product'])) {
