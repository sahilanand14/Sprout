   ...
   <script src="js/jquery-1.11.3.min.js" type="text/javascript"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:16px;left:0px;width:980px;height:530px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:530px;overflow:hidden;">
            ...
            <div>
                <img data-u="image" src="photos/ba5.jpg" />
            </div>
            <div>
                <img data-u="image" src="photos/ba6.jpg" />
            </div>
    ...
    <!-- #endregion Jssor Slider End -->
        ...
        <div id="mobikwick-container">
            <h2>USE the MOBIKWIK WALLET ON SPROUT AND GET 15% SUPERCASH</h2>
        ...
        <!-- discounts -->
        <div id="various-brands">
            <div><span id="handpicked-container">HANDPICKED</span>
                <div class="sub-heading handpicked"> The best of global brands, at your doorsteps!</div>
            </div>
            <div >
                <div class="card">
                    <img src="photos\watches.jpg" height="220px;">
                    <div class="card-text"><b>SPECIAL GIFT FOR YOUR LOVED ONES</b>
                        <div class="sub-heading">classic stylish watches.</div>
                    </div>
                </div>
                <div class="card">
                    <img src="photos\shoes1.jpg" height="220px;">
                    <div class="card-text"><b>BETTER YOUR PERFORMANCE</b>
                        <div class="sub-heading">with the right gear.</div>
                    </div>
                </div>
                <div class="card">
                    <img src="photos\topwear.jpg" height="220px;">
                    <div class="card-text"><b>UPTO 80% OFF </b>
                        <div class="sub-heading">On the brands you love.</div>
                    </div>
                </div>
                <div class="card">
                    <img src="photos\wtopwear.jpg" height="220px;">
                    <div class="card-text"><b>UPTO 70% OFF</b>
                        <div class="sub-heading">On women Apparells</div>
                    </div>
                </div>
                <div class="clear-containers"></div>
            </div>
            <div>
                <div class="card">
                    <img src="photos\wallet.jpg" height="220px;">
                    <div class="card-text"><b>UPTO 50% OFF</b>
                        <div class="sub-heading">On wallets.</div>
                    </div>
                </div>
                <div class="card">
                    <img src="photos\belts.jpg" height="220px;">
                    <div class="card-text"><b>BETTER YOUR PERFORMANCE</b>
                        <div class="sub-heading">with the right gear.</div>
                    </div>
                </div>
                <div class="card">
                    <img src="photos\perfumes.jpg" height="220px;">
                    <div class="card-text"><b>AMAZING OFFERS</b>
                        <div class="sub-heading">On perfumes and deodrants.</div>
                    </div>
                </div>
                <div class="card">
                    <img src="photos\sandals.jpg" height="220px;">
                    <div class="card-text"><b>MAJOR DISCOUNTS</b>
                        <div class="sub-heading">On women footwear.</div>
                    </div>
                </div>
                <div class="clear-containers"></div>
            </div>
        ...
        <!-- brand starts -->
         <div id="various-brands">
            <div><span id="handpicked-container">TOP BRANDS</span>
                <div class="sub-heading handpicked"> The best of global brands, at your doorsteps!</div>
            </div>
            <div >
                <div class="card">
                <a href=index1.php?brand=2>
                    <img src="photos\brand1.jpg" height="220px;">
                    <div class="card-text"><b>ROADSTER</b>
                        <!-- <div class="sub-heading">classic stylish watches.</div> -->
                    </div>
                    </a>
                </div>
                <div class="card">
                <a href=index1.php?brand=3>
                    <img src="photos\brand2.jpg" height="220px;">
                    <div class="card-text"><b>TOMMY HILFIGER</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
                <div class="card">
                <a href=index1.php?brand=4>
                    <img src="photos\brand3.jpg" height="220px;">
                    <div class="card-text"><b>MAD AND HARBOUR</b>
                        <!-- <div class="sub-heading">On the brands you love.</div> -->
                    </div>
                    </a>
                </div>
                <div class="card">
                <a href=index1.php?brand=5>
                    <img src="photos\brand4.jpg" height="220px;">
                    <div class="card-text"><b>DANIEL KLEIN</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
            ...
            <div>
                <div class="card">
                <a href=index1.php?brand=6>
                    <img src="photos\brand5.jpg" height="220px;">
                    <div class="card-text"><b>JACK AND JONES</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
                <div class="card">
                <a href=index1.php?brand=7>
                    <img src="photos\brand6.jpg" height="220px;">
                    <div class="card-text"><b>JOHN PLAYERS</b></a>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                </div>
                <div class="card">
                <a href=index1.php?brand=8>
                    <img src="photos\brand7.jpg" height="220px;">
                    <div class="card-text"><b>HRX</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
                <div class="card">
                <a href=index1.php?brand=9>
                    <img src="photos\brand8.jpg" height="220px;">
                    <div class="card-text"><b>VERO MODA</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
             ...
             <div>
                <div class="card">
                <a href=index1.php?brand=10>
                    <img src="photos\brand9.jpg" height="220px;">
                    <div class="card-text"><b>BIBA</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
                <div class="card">
                <a href=index1.php?brand=1>
                    <img src="photos\brand10.jpg" height="220px;">
                    <div class="card-text"><b>PUMA</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
                <div class="card">
                <a href=index1.php?brand=11>
                    <img src="photos\brand11.jpg" height="220px;">
                    <div class="card-text"><b>NIKE</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
                <div class="card">
                <a href=index1.php?brand=12>
                    <img src="photos\brand12.jpg" height="220px;">
                    <div class="card-text"><b>WRANGLER</b>
                        <!-- <div class="sub-heading">with the right gear.</div> -->
                    </div>
                    </a>
                </div>
       ...
       <!-- brands ends -->
        ...
        <div class="footer-container">
            <div>
                ...
                <hr/>
                <div  id="Registered-Office-Address" class="Registered-Office-Address">
